...
<html>
<head>
 <meta http-equiv='refresh' content='0; URL=consulta.jsp?pesquisar=Pesquisar&pesquisa=0'>
...
try {
   ...
   /* out.print(iv1);out.print("<br>");
    ...
    //String sql = "UPDATE vagas SET descricao = " + ds1 + ", req_obrigatorios = "+ro1+", req_desejaveis = "+rd1+", remuneracao = "+re+", aberta = "+ab1+", beneficios = "+be1+", local_trabalho = " +lt1+  " WHERE idvaga="  + 1016";
    String sql = "UPDATE vagas SET descricao=?, req_obrigatorios=?, req_desejaveis=?, remuneracao=?, aberta=?, beneficios=?, local_trabalho=? WHERE idvaga="+id;
